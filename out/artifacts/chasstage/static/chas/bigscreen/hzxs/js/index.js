...
function addRyIcon(ryxx,x,y,iw,ih) {
    ...
    var picName='/static/chas/bigscreen/bjfj/images/pos.png';
    if(ryxx.tsqt==3||ryxx.tsqt==5||ryxx.tsqt==11||ryxx.tsqt==14){
        picName='/static/chas/bigscreen/bjfj/images/red.png';
    }else if(ryxx.tsqt==4||ryxx.tsqt==6||ryxx.tsqt==10){
        picName='/static/chas/bigscreen/bjfj/images/orange.png';
    }else if(ryxx.tsqt==1||ryxx.tsqt==2||ryxx.tsqt==7||ryxx.tsqt==8||ryxx.tsqt==12){
        picName='/static/chas/bigscreen/bjfj/images/yellow.png';
    }else{
        picName='/static/chas/bigscreen/bjfj/images/blue.png';
    }
    var name =$('<div class="plname" style="left:'+x+'px;top:'+name_top+'px;">'+ryxm+'</div>');
...
function addRyIcon1(ryxx,x,y,iw,ih) {
    ...
    if("R"==lx){
        icon=$('<div class="xyr" rybh="'+ryxx.rybh+'" ryxm="'+ryxx.xm+'" qymc="'+ryxx.qymc+'" qyid="'+ryxx.qyid+'" style="position: absolute; left: '+x+'px;top: '+y+'px; width: '+iw+'px; height: '+ih+'px;">\n' +
            ...
            '<div class="plname" style="position:absolute;left:'+x+'px;top:'+name_top+'px;font-size:12px;width: 20px;text-align: center;color: red;font-family: 微软雅黑;">'+ryxx.xm+'</div>'+
            '                </div>');
    }else if("M"==lx){
