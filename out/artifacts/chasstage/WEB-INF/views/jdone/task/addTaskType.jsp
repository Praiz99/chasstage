...
<html>
  <head>
    ...
    <script type="text/javascript" src="${ctx}/static/jdone/js/task/addTaskType.js"></script>
...
<body>
	    ...
	    <div class="form-panel">
	    	...
	    	<table class="table_form">
	    		<tr>
	    			<th width="12%">分类名称:</th>
	    			<td width="38%"><input class="required" type="text" name="typeName" ></input></td>
	    			<th width="12%">分类标识:</th>
		    		<td width="38%"><input class="required" type="text" name="typeMark" ></input></td>
	    		</tr>
	    		<tr>
	    			<th width="12%">部署名称:</th>
	    			<td width="38%">
