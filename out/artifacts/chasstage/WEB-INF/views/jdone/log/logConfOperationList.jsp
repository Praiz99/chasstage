...
<script type="text/javascript"
	src="${ctx}/static/jdone/js/log/logConfOperationList.js"></script>
			...
			<form id="searchForm">
				<table>
					<tr class="searchTr">
						...
						<td><label class="search-label">操作分类:</label><input name="operTypr" type="text" class="search-textbox keydownSearch" /></td>
						<td><label class="search-label">页面/操作名称:</label><input name="operName" type="text" class="search-textbox keydownSearch" /></td>
						<td><label class="search-label">操作路径:</label><input name="servletPath" type="text" class="search-textbox keydownSearch" /></td>
					</tr>
				</table>
