...
<head>
    ...
    <script type="text/javascript" src="${ctx}/static/framework/plugins/jquery-plugins/validate/jquery.validate.min.js"></script>
     <script type="text/javascript" src="${ctx}/static/jdone/js/db/resScriptAddForm.js"></script>
    <script type="text/javascript">
    	var ctx = '${ctx}';
    </script>
</head>
<body>
	<div id="scriptInfo" class="easyui-tabs" style="width:100%;height:auto;">
		<div title="新增查询脚本">
			...
			<div class="form-panel">
				<div class="panel-body">
					<div class="form-btns">
						<input id="btnSubmit" class="button" type="button" value="保 存" onclick="saveScript()">&nbsp;
