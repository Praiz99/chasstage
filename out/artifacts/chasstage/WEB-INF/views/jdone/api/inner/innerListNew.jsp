...
<title>内接口管理</title>
 <%-- <link rel="stylesheet" type="text/css" href="${ctx}/static/framework/style/css/default/bootstrap.min.css"> --%>
    ...
    <script type="text/javascript" src="${ctx}/static/jdone/js/api/inner/innerListNew.js"></script>
...
<body  class="easyui-layout" style="overflow-y: hidden"  scroll="no">
     <div region="north" style="width:auto;height: 35px;overflow-y: hidden">
    ...
    <div id="mainPanle" region="center" style="background: #eee; overflow-y:hidden">
        <div id="tabs" class="easyui-tabs"  fit="true" border="false" >
			<iframe id="operFrame" frameborder="0" scrolling="no" src="innerList" style="width:100%;height:95%;"/>
		</div>
    </div>
</body>
</html>
