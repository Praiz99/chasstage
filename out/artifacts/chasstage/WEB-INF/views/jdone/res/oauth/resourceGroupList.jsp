...
<head>
    ...
    <script type="text/javascript" src="${ctx}/static/jdone/js/res/oauth/resourceGroupList.js"></script>
</head>
<body style="height:98%" >
<!-- 菜单按钮  开始 -->
<div class="easyui-panel" style="padding:5px;background-color: #d6e7f7;">
    <a href="javaScript:saveResourceSettings();" class="easyui-linkbutton" data-options="iconCls:'icon-save'">保存</a>
    <a href="javaScript:openResourceSettings();" class="easyui-linkbutton" data-options="iconCls:'icon-add'">添加分组</a>
    <a href="javaScript:UpdateTree();" class="easyui-linkbutton" data-options="iconCls:'icon-edit'">修改分组</a>
    <a href="javaScript:deleteResourceBytreeId();" class="easyui-linkbutton" data-options="iconCls:'icon-remove'">删除</a>
</div>

<!-- 菜单树  开始 -->
<div class="easyui-layout" id="layout" style="width:100%;height:80%;">
    <div id="p" data-options="region:'west'" title="授权资源管理" style="width:25%;">
        <table border="0" width="99%" class="table-detail"  style="margin: 1px;">
            ...
            <tr style="border: 1px solid #7babcf;">
                ...
                <td style="border: 1px solid #7babcf;font-family: sans-serif;padding-left:5px;">
                    <input id="resourceName" name="resourceName" type="text" class="inputText" style="width:60%;height: 25px;">
    ...
    <div data-options="region:'center'" title="授权资源" style="width:100%;height:80%;">
