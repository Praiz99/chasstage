											...
											<tr height="450px" valign="top">
												<td>
													...
													<div class="b-news-view-info">
														...
														<div class="b-news-view-info-single">
														<!-- 发布时间？ -->
															发布时间：<fmt:formatDate value="${notice.fbsj }" pattern="yyyy-MM-dd HH:mm:ss"/>
														</div>
														<div class="cb"></div>
														<!-- 清除浮动样式 -->
													</div>
													<div class="b-news-view-content">${notice.content }</div>
												</td>
											</tr>
										</table>
									</td>
										...
										<div class="b-news-rel-div" style="width: 300px">
											<div class="list-ul-b">
												<div class="list-ul-b-div">
													...
													<ul class="attachment">
													     <c:forEach var="fileInfo" varStatus="noticeStatus" items="${fileInfoList}"> 
													    	<li>${fileInfo.realName}<span style="width:30px;float:right"><a  target="_blank" style="text-decoration:underline;" href="${fileInfo.downUrl}">下载</a></span></li>
													    </c:forEach>
													</ul>
												</div>
											</div>
