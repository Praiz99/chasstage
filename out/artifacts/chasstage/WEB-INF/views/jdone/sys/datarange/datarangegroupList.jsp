...
<script type="text/javascript" src="${ctx}/static/jdone/js/sys/datarangegroup/datarangegroupList.js"></script>
</head>
<body style="height:98%" >
	...
	<div class="easyui-layout" id="layout" style="width:100%;height:100%;">
		<div id="p" data-options="region:'west'" title="权限管理" style="width:25%;">
		...
		<div data-options="region:'center'" title="权限配置">
			<iframe id="mainForm" name="mainForm" src="" style="width: 99%;height: 90%;" scrolling="no"  frameborder="no" border="0"></iframe> 
		</div>
	</div>
	<!-- 菜单树 结束 -->
</body>
