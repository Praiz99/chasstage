...
<html>
  <head>
    ...
    <script type="text/javascript" src="${ctx}/static/jdone/js/sys/org/orgList.js"></script>
	...
	<div id="content" class="row-fluid" style="height: 100%;">
		<div id="left" class="accordion-group" style="width: 17%; height: 100%;float: left;">
			<div class="accordion-heading">
		    	<a class="accordion-toggle" style="color:#2fa4e7;text-decoration:none">组织机构<i class="easyui-linkbutton" data-options="plain:true,iconCls:'icon-reload'" style="width: 25px;height: 18px;vertical-align: baseline;float: right;" onclick="refreshTree();"></i></a>
		    </div>
			<div id="ztree" class="ztree" style="overflow:auto;margin:0;_margin-top:10px;padding:10px 0 0 10px;height: 92%;"></div>
		</div>
		<div id="openClose" class="close">&nbsp;</div>
		<div id="center" style="height: 100%; width: 80%;float: left;border: 1px solid #e5e5e5">
			<iframe width="100%" height="800px" frameborder="0" src=""></iframe>
		</div>
