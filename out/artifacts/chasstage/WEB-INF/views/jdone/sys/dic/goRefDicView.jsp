	    	         ...
	    	         <div class="panel-body">
	                  <table class="table_form" width="80%">
					          <tr>
						         ...
						         <td>
							        <select id="sourceMark" name="sourceMark"  style="width:300px;" onchange="changeDb();" disabled> 
							             <c:if test="${dic.sourceMark!=null}">
								             <option value="${dic.sourceMark}" selected>
								             		${dic.sourceName}
								             		<c:if test="${dic.sourceName==null}">${dic.sourceMark}</c:if>
								             </option>							             
							             </c:if>
						            </select>
						         </td>
