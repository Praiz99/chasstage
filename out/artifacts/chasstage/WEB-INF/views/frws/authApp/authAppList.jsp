...
<html>
  <head>
    ...
    <script type="text/javascript" src="${ctx}/static/frws/authApp/authAppList.js"></script>
				...
				<form id="searchForm">
					<table>
                        <tr class="searchTr">
                            <th>应用名称：</th>
                            <td>
                                <input name="authAppName" class="easyui-textbox keydownSearch"/>
							</td>
                            <th>应用标识：</th>
                            <td>
                                <input name="authAppMark" class="easyui-textbox keydownSearch"/>
							</td>
                            <td>
