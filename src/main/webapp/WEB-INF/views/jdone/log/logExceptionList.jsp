...
<html>
  <head>
    <title>系统异常日志管理</title>
	<%@ include file="/WEB-INF/views/framework/include/default.jsp"%>  
    <script type="text/javascript" src="${ctx}/static/jdone/js/log/logExceptionList.js"></script>
				...
				<form id="searchForm">
					<table>
                        <tr class="searchTr">
                            ...
                            <th>模块名称：</th>
                            <td>
                                <input name="moduleName" class="easyui-textbox"/>
							</td>
                            <td colspan="6" style="algin:center">
