...
<html>
  <head>
    ...
    <script type="text/javascript" src="${ctx}/static/jdone/js/log/logInterfaceList.js"></script>
	...
	<div >
		<div class="row-fluid">
			<form id="searchForm">
				<table>
					<tr class="searchTr">
						<td><label class="search-label">用户名称:</label><input name="userName" type="text" class="search-textbox keydownSearch" /></td>
						<td><label class="search-label">用户身份证号:</label><input name="userIdCard" type="text" class="search-textbox keydownSearch" /></td>
						<td><label class="search-label">接口名称:</label>
							<input name="interfaceName" type="text" class="search-textbox keydownSearch" />
						</td>
						<td><label class="search-label">操作时间:</label>
						...
						<td><label class="search-label">操作ip:</label>
							<input name="reqClientIp" type="text" class="search-textbox keydownSearch" />
						</td>
					</tr>
				</table>
