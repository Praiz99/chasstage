...
<script type="text/javascript" src="${ctx}/static/jdone/js/sys/paramgroup/paramgroupList.js"></script>
</head>
<body style="height:98%" >
	...
	<div class="easyui-layout" id="layout" style="width:100%;height:80%;">
		<div id="p" data-options="region:'west'" title="参数管理" style="width:25%;">
		...
		<div data-options="region:'center'" title="系统参数" style="width:100%;height:80%;">
