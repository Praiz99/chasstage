...
<html>
  <head>
    ...
    <script type="text/javascript" src="${ctx}/static/jdone/js/task/addTaskBatchinst.js"></script>
	...
	<div id="tt" class="easyui-tabs" style="width:100%;height:800px;">
	    ...
	    <div class="form-panel">
	    	...
	    	<table class="table_form">
	    		<tr>
	    			<th width="12%">任务名称:</th>
	    			<td width="38%"><input class="required" type="text" name="taskName" ></input></td>
	    			<th width="12%">任务标识:</th>
		    		<td width="38%"><input class="required" type="text" name="taskMark" ></input></td>
	    		</tr>
	    		<tr>
	    			<th width="12%">部署名称:</th>
		    		<td width="38%">
	    		...
	    		<tr class="1">	 
	    			...
	    			<th width="12%">输入表名:</th>
		    		<td width="38%">
		    			<input name="inputTable" id="inputTable" readonly="readonly" type="text" maxlength="200"/>
	    		...
	    		<tr class="3">	 
	    			...
	    			<th width="12%">输出表名:</th>
		    		<td width="38%">
		    			<input name="outputTable" id="outputTable"  readonly="readonly" type="text" maxlength="200"/>
						<a href="#" onclick="showTables(2);">选择</a>
		    		</td>
	    		</tr>
	    		<tr>
	    			<th width="12%">任务描述:</th>
	    			<td colspan="3"><textarea class="required" name="taskDesc" style="width:66%;height:80px;"></textarea></td>
	    		</tr>
	    	</table>
	    	<div class="form-btns">
