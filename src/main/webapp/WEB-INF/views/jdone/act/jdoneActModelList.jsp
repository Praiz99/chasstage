...
<html>
  <head>
    ...
    <script type="text/javascript" src="${ctx}/static/jdone/js/act/jdoneActModelList.js"></script>
...
<body style="height: 95%;">
	<div id="content" class="row-fluid" style="height: 95%;">
		<div id="left" class="accordion-group" style="width: 17%; height: 95%;float: left;">
			...
			<div id="ztree" class="ztree" style="overflow:auto;margin:0;_margin-top:10px;padding:10px 0 0 10px;height: 93%;"></div>
		</div>
		<div id="openClose" class="close">&nbsp;</div>
		<div id="center" style="height: 100%; width: 80%;float: left;border: 1px solid #e5e5e5">
			<iframe style="width: 100%;height: 100%;" frameborder="0" src="${ctx}/act/model/actModelForm"></iframe>
		</div>
		<div id="right" style="height: 95%; width: 80%;float: left;">
			<div class="searchDiv">
				<form id="searchForm">
					<table>
                        <tr class="searchTr">
