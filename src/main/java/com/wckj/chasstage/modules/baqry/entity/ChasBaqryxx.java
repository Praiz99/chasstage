package com.wckj.chasstage.modules.baqry.entity;


import java.util.Date;

public class ChasBaqryxx {

    private static final long serialVersionUID = -3133008147200502912L;
    ...
    public void setTjxgrsfzh(String tjxgrsfzh) {
        this.xgrSfzh = tjxgrsfzh == null ? null : tjxgrsfzh.trim();
    }

    public Date getTjxgsj() {
        return xgsj;
    }

    public void setTjxgsj(Date tjxgsj) {
        this.xgsj = tjxgsj;
    }
    ...
    public void setRSsms(String rSsms) {
        ...
        this.ssms = rSsms == null ? null : rSsms.trim();
        this.rSsms = "";
    }
    ...
    public void setZhdxzqh(String zhdxzqh) {
        this.zhdxzqh = zhdxzqh == null ? null : zhdxzqh.trim();
    }
    ...
    public void setZhdxzqhmc(String zhdxzqhmc) {
        this.zhdxzqhmc = zhdxzqhmc == null ? null : zhdxzqhmc.trim();
    }

    public String getSswpzt() {
        return sswpzt == null ? null : sswpzt.trim();
    }
    ...
    public void setCkzkzpid(String ckzkzpid) {
        this.ckzkzpid = ckzkzpid == null ? null : ckzkzpid.trim();
    }
