...
public class QqdhBean {
     ...
     * 腕带编号（未使用）
     */
    @ApiModelProperty(value = "腕带编号（未使用）")

    private String wdbh;
    /**
     * 状态 默认---0
     */
    @ApiModelProperty(value = "状态 默认---0")
     ...
     * 申请通话时长 单位分钟
     */
    @ApiModelProperty(value = "申请通话时长单位分钟")
    ...
    @ApiParam(value = "联系人电话", required = true)
    private String lxrdh;
    /**
     * 申请原因
     */
    @ApiModelProperty(value = "申请原因")
    @ApiParam(value = "申请原因", required = true)
    private String sqyy;
    //
    /**
     * 申请人姓名
